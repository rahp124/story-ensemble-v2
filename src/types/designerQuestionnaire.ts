...
export const DESIGNER_CONTENT_QUESTIONS: Record<DesignerQuestionFrameType, DesignerContentQuestion[]> = {
  Context: [
    { id: 'ctx-goal',          text: 'What were you doing right before your last experience, and what did you want to accomplish?', phase: 'generation' },
...
export const DESIGNER_REFLECTION_QUESTIONS: Omit<DesignerContentQuestion, 'phase'>[] = [
  ...
  { id: 'reflect-mind',    text: "Write one sentence describing your emotions at this part of your story:" }
];
