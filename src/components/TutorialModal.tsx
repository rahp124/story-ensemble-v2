      ...
      >
        ...
        <Menu.Dropdown>
          ...
          >
            ...
            <Menu.Item
              leftSection={
                <Move3DIcon style={{ width: rem(14), height: rem(14) }} />
              }
              rightSection={
                <Text size="xs" c="dimmed">
                  {' '}
            ...
            <Menu.Item
              leftSection={
                <ScanSearchIcon style={{ width: rem(14), height: rem(14) }} />
              }
              rightSection={
                <Text size="xs" c="dimmed">
                  {' '}
            ...
            <Menu.Item
              leftSection={
                <UserRoundIcon style={{ width: rem(14), height: rem(14) }} />
              }
              rightSection={
                <Text size="xs" c="dimmed">
            ...
            <Menu.Item
              ...
              onClick={() =>
                handleOpen(
                  'Design Thinking - Hybriad Approach',
                  'https://www.youtube.com/embed/xpVMp1WRwI0?si=8pjPtVNAOdltBADS'
                )
              }
            >
            ...
            <Menu.Item
              leftSection={
                <SparklesIcon style={{ width: rem(14), height: rem(14) }} />
              }
              onClick={() =>
                handleOpen(
                  'Generate ____',
            ...
            <Menu.Item
              leftSection={
                <BookImageIcon style={{ width: rem(14), height: rem(14) }} />
              }
              onClick={() =>
                handleOpen(
            ...
            <Menu.Item
              leftSection={
                <RefreshCwIcon style={{ width: rem(14), height: rem(14) }} />
              }
              onClick={() =>
                handleOpen(
                  'Storyboarding - Updating Single Frame',
                  'https://www.youtube.com/embed/xpVMp1WRwI0?si=8pjPtVNAOdltBADS'
                )
              }
            >
            ...
            <Menu.Item
              leftSection={
                <SquareStackIcon style={{ width: rem(14), height: rem(14) }} />
              }
              onClick={() =>
                handleOpen(
                  'Explore - More ___',
            ...
            <Menu.Item
              leftSection={
                <ScanEyeIcon style={{ width: rem(14), height: rem(14) }} />
              }
              onClick={() =>
                handleOpen(
            ...
            <Menu.Item
              leftSection={
                <WandSparklesIcon style={{ width: rem(14), height: rem(14) }} />
              }
              onClick={() =>
                handleOpen(
                  'Iterate - Revise with AI',
                  'https://www.youtube.com/embed/xpVMp1WRwI0?si=8pjPtVNAOdltBADS'
                )
              }
            >
            ...
            <Menu.Item
              ...
              onClick={() =>
                handleOpen(
                  'Example Workflow - Return to Persona & Iterate',
                  'https://www.youtube.com/embed/xpVMp1WRwI0?si=8pjPtVNAOdltBADS'
                )
              }
            >
            ...
            <Menu.Item
              ...
              onClick={() =>
                handleOpen(
                  'Example Workflow - Return to Problem & Iterate',
                  'https://www.youtube.com/embed/xpVMp1WRwI0?si=8pjPtVNAOdltBADS'
                )
              }
            >
            ...
            <Menu.Item
              ...
              onClick={() =>
                handleOpen(
                  'Example Workflow - Return to Solution & Iterate',
                  'https://www.youtube.com/embed/xpVMp1WRwI0?si=8pjPtVNAOdltBADS'
                )
              }
            >
